...
def main():
    ...
    if isMC:
        ...
        jetmetCorrector_2018 = createJMECorrector(isMC=True, dataYear="UL2018", runPeriod="B", jesUncert="Total", jetType="AK4PFchs",applyHEMfix=True)
        fatJetCorrector_2018 = createJMECorrector(isMC=True, dataYear="UL2018", runPeriod="B", jesUncert="Total", jetType="AK8PFchs",applyHEMfix=True)
        ...
        if year == 2018:
            modulesToRun.extend([jetmetCorrector_2018(), fatJetCorrector_2018(), puidSF(), muonScaleRes(), gammaSF(),LHEScaleSF()])
